<!-- Additional CSS -->
<style>
    /* Update the font styles for specific elements */
    h1, h4, p, small {
 ...
 <!-- Header-->
 <header class="bg-dark py-5" id="main-header" style="font-family: 'Courier New', Courier, monospace;">
...
<!-- Section-->
<section class="py-5" style="font-family: 'Courier New', Courier, monospace;">
